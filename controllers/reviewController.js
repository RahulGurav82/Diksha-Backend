...
const reviewController = {
    ...
    addReview: async (req, res) => {
        try {
            //('Adding review - Request body:', req.body);
            //('User ID from auth middleware:', req.userId);
            ...
            //('User found:', user.name, 'with avatar:', user.avatar);
            ...
            //('Saving review:', review);
            const savedReview = await review.save();
            //('Review saved with ID:', savedReview._id);
            
            // Populate user details in the response
            const populatedReview = await Review.findById(savedReview._id)
                .populate('userId', 'name avatar');
            
            //('Populated review:', populatedReview);
